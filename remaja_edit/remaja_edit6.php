    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Farmala</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_farmala WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alamat = "Kedai Runding"; // Desa tetap
    ...
    $stmt = $conn->prepare("UPDATE remaja_farmala SET 
...
<html>
<head>
    <title>Edit Data Remaja - Kedai Runding</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Kedai Runding - Sistem Informasi Remaja</p>
    </div>
