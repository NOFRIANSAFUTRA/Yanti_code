    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Maulana</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_Maulana WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alamat = "Rantau Binuang"; // Desa tetap
    ...
    $stmt = $conn->prepare("UPDATE remaja_Maulana SET 
...
<html>
<head>
    <title>Edit Data Remaja - Rantau Binuang</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Rantau Binuang - Sistem Informasi Remaja</p>
    </div>
