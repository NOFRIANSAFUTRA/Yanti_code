    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Dedi</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_Dedi WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE remaja_Dedi SET 
...
<html>
<head>
    <title>Edit Data Remaja - Indra Damal</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Indra Damal - Sistem Informasi Remaja</p>
    </div>
