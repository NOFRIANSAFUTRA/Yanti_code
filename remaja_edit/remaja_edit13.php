    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Budi</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_Budi WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alamat = "pasi Meurapat"; // Desa tetap
    ...
    $stmt = $conn->prepare("UPDATE remaja_Budi SET 
...
<html>
<head>
    <title>Edit Data Remaja - pasi Meurapat</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa pasi Meurapat - Sistem Informasi Remaja</p>
    </div>
