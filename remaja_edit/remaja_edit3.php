    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Bariah</strong> untuk menjaga keamanan dan integritas data.
            </div>
            
            <?php if (isset($_SESSION['username']) && isset($_SESSION['role'])): ?>
            <!-- [KODE USER INFO TIDAK BERUBAH] -->
            <?php endif; ?>
...
// Menggunakan tabel remaja_rian untuk Rian
$stmt = $conn->prepare("SELECT * FROM remaja_bariah WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alamat = "Barat Daya"; // Desa diubah ke Ujung Padang
    $umur = hitungUmur($tgl_lahir); // Hitung umur dalam tahun
    
    // Update data di tabel remaja_rian
    $stmt = $conn->prepare("UPDATE remaja_bariah SET 
...
<html>
<head>
    <title>Edit Data Remaja - Ujung Padang</title> <!-- Judul diubah -->
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Ujung Padang - Sistem Informasi Remaja</p> <!-- Desa diubah -->
    </div>
...
<html>
<head>
    <title>Edit Data Remaja - Sialang</title>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        body { 
...
<div class="container">
    <div class="header">
        <h2><i class="fas fa-edit"></i> Edit Data Remaja</h2>
        <p>Desa Sialang - Sistem Informasi Remaja</p>
    </div>
