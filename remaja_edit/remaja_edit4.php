    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Nawawi</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_Nawawi WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE remaja_nawawi SET 
...
<html>
<head>
    <title>Edit Data Remaja - Kapeh</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Kapeh - Sistem Informasi Remaja</p>
    </div>
