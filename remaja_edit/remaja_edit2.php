    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Rian</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_rian WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alamat = "Ujung Padang"; // Desa diubah ke Ujung Padang
    $umur = hitungUmur($tgl_lahir); // Hitung umur dalam tahun
    
    // Update data di tabel remaja_rian
    $stmt = $conn->prepare("UPDATE remaja_rian SET 
