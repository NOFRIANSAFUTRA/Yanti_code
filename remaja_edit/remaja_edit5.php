    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Ali</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_Ali WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alamat = "Kedai Kandang"; // Desa tetap
    ...
    $stmt = $conn->prepare("UPDATE remaja_Ali SET 
...
<html>
<head>
    <title>Edit Data Remaja - Kedai Kandang</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Kedai Kandang - Sistem Informasi Remaja</p>
    </div>
