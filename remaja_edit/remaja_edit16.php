    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Lina</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_Lina WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE remaja_Lina SET 
...
<html>
<head>
    <title>Edit Data Remaja - Pasi Lembang</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Pasi Lembang - Sistem Informasi Remaja</p>
    </div>
