    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Remaja</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Ari</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM remaja_Ari WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE remaja_Ari SET 
...
<html>
<head>
    <title>Edit Data Remaja - Pulo ie</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Pulo ie - Sistem Informasi Remaja</p>
    </div>
