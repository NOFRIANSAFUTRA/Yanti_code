    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                <strong>Fitur Penghapusan Data Remaja</strong> memiliki akses super terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Ali</strong> untuk mencegah penghapusan data yang tidak disengaja atau tidak sah.
                <br><br>
...
if ($id > 0) {
    // Cek apakah data ada
    $stmt = $conn->prepare("SELECT nama FROM remaja_Ali WHERE id = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        // Hapus data
        $stmt = $conn->prepare("DELETE FROM remaja_Ali WHERE id = ?");
        $stmt->bind_param("i", $id);
