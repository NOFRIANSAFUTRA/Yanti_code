        ...
        <div class="access-denied-container">
            ...
            <div class="danger-alert">
                <div class="danger-alert-text">
                    ...
                    Halaman ini digunakan untuk menghapus data remaja secara permanen
                </div>
            </div>
            
            <div class="error-message">
                <strong>Fitur Penghapusan Data Remaja</strong> memiliki akses super terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Maulana</strong> untuk mencegah penghapusan data yang tidak disengaja atau tidak sah.
                <br><br>
...
if ($id > 0) {
    // Cek apakah data ada
    $stmt = $conn->prepare("SELECT nama FROM remaja_Maulana WHERE id = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        $log_data = [
            ...
            'action' => 'DELETE_REMAJA_DATA',
            'remaja_id' => $id,
            'remaja_name' => $data['nama'],
        ...
        // Hapus data
        $stmt = $conn->prepare("DELETE FROM remaja_Maulana WHERE id = ?");
        $stmt->bind_param("i", $id);
            ...
            <body>
                <script>
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil!',
                        text: 'Data remaja "<?php echo htmlspecialchars($data['nama']); ?>" berhasil dihapus.',
        ...
        <body>
            <script>
                Swal.fire({
                    ...
                    text: 'Data remaja yang ingin dihapus tidak tersedia.',
                    showConfirmButton: true,
                    confirmButtonColor: '#3085d6',
                    confirmButtonText: 'OK'
                }).then((result) => {
