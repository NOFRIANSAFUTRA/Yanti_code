    ...
    if ($password !== $confirmPassword) {
        ...
        if (mysqli_stmt_num_rows($stmt) > 0) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                $success = "Akun petugas berhasil ditambahkan!";
            } else {
...
<head>
    ...
    <title>Tambah Akun Petugas - Admin Posyandu</title>
...
<body>
    <div class="container">
        <div class="form-container">
            <h2 class="form-title"><i class="fas fa-user-plus me-2"></i>Tambah Akun Petugas</h2>
