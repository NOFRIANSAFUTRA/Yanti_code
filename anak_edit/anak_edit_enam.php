    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Anak</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama farmala</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
// PERBAIKAN: Pastikan nama tabel konsisten - gunakan anak_farmala
$stmt = $conn->prepare("SELECT * FROM anak_farmala WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data
    $stmt = $conn->prepare("UPDATE anak_farmala SET 
