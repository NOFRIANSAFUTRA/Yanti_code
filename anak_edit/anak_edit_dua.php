    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Anak</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Bariahh</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'kader' || $_SESSION['username'] !== 'Bariah') {
    showAccessDenied();
}
...
// PERBAIKAN: Pastikan nama tabel konsisten - gunakan anak_bariah
$stmt = $conn->prepare("SELECT * FROM anak_bariahh WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data
    $stmt = $conn->prepare("UPDATE anak_bariahh SET 
