    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Anak</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Lina</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'kader' || $_SESSION['username'] !== 'Lina') {
    showAccessDenied();
}
...
// PERBAIKAN: Pastikan nama tabel konsisten - gunakan anak_Lina
$stmt = $conn->prepare("SELECT * FROM anak_Lina WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data
    $stmt = $conn->prepare("UPDATE anak_Lina SET 
