    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Anak</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Rian</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
<!--                 
                <a href="data_anak.php" class="btn btn-secondary">
...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'kader' || $_SESSION['username'] !== 'Rian') {
    showAccessDenied();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $alamat = "Ujung Padang"; // Desa tetap
    $umur = hitungUmurBulan($tgl_lahir); // Hitung umur dalam bulan
    
    // Update data
    $stmt = $conn->prepare("UPDATE anak SET 
...
<!-- Sisanya adalah form edit yang sudah ada -->
<!DOCTYPE html>
<html>
<head>
    <title>Edit Data Anak - Ujung Padang</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Ujung Padang - Sistem Informasi Balita</p>
    </div>
