        ...
        <div class="access-denied-container">
            ...
            <div class="danger-alert">
                <div class="danger-alert-text">
                    ...
                    Halaman ini digunakan untuk menghapus data anak secara permanen
                </div>
            </div>
            
            <div class="error-message">
                <strong>Fitur Penghapusan Data Anak</strong> memiliki akses super terbatas dan hanya dapat digunakan oleh <strong>Kader bernama maulana</strong> untuk mencegah penghapusan data yang tidak disengaja atau tidak sah.
                <br><br>
...
if ($id > 0) {
    // Cek apakah data ada
    $stmt = $conn->prepare("SELECT nama FROM anak_maulana WHERE id = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        // Hapus data
        $stmt = $conn->prepare("DELETE FROM anak_maulana WHERE id = ?");
        $stmt->bind_param("i", $id);
            ...
            <body>
                <script>
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil!',
                        text: 'Data anak "<?php echo htmlspecialchars($data['nama']); ?>" berhasil dihapus.',
        ...
        <body>
            <script>
                Swal.fire({
                    ...
                    text: 'Data anak yang ingin dihapus tidak tersedia.',
                    showConfirmButton: true,
                    confirmButtonColor: '#3085d6',
                    confirmButtonText: 'OK'
                }).then((result) => {
