    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Lansia</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Farmala</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM lansia_Farmala WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE lansia_Farmala SET 
...
<html>
<head>
    <title>Edit Data Lansia - kedai Runding</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa kedai Runding - Sistem Informasi Lansia</p>
    </div>
