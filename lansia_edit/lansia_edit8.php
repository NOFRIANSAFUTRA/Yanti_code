    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Lansia</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Maulana</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM lansia_Maulana WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE lansia_Maulana SET 
...
<html>
<head>
    <title>Edit Data Lansia - Rantau Binuang</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Rantau Binuang - Sistem Informasi Lansia</p>
    </div>
