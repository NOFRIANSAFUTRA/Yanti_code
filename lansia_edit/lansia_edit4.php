    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Lansia</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Nawawi</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM lansia_Nawawi WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE lansia_Nawawi SET 
...
<html>
<head>
    <title>Edit Data Lansia - Kapeh</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Kapeh - Sistem Informasi Lansia</p>
    </div>
