    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Lansia</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Bariah</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM lansia_Bariah WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE lansia_Bariah SET 
...
<html>
<head>
    <title>Edit Data Lansia - Barat Daya</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Barat Daya - Sistem Informasi Lansia</p>
    </div>
