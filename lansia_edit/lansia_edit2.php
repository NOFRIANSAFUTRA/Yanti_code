    ...
    <body>
        <div class="access-denied-container">
            ...
            <div class="error-message">
                ...
                <strong>Halaman Edit Data Lansia</strong> ini memiliki akses terbatas dan hanya dapat digunakan oleh <strong>Kader bernama Rian</strong> untuk menjaga keamanan dan integritas data.
            </div>
...
$stmt = $conn->prepare("SELECT * FROM lansia_Rian WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE lansia_Rian SET 
...
<html>
<head>
    <title>Edit Data Lansia - Ujung Padang</title>
...
<div class="container">
    <div class="header">
        ...
        <p>Desa Ujung Padang - Sistem Informasi Lansia</p>
    </div>
